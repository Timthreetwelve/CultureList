...
#region Cultures
/// <summary>
/// Subset of CultureTypes enum that are not deprecated.
/// </summary>
[TypeConverter(typeof(EnumDescriptionTypeConverter))]
public enum Cultures
{
    [LocalizedDescription("SettingsEnum_Culture_NeutralCutures")]
    NeutralCultures = 1,
    [LocalizedDescription("SettingsEnum_Culture_SpecificCutures")]
    SpecificCultures = 2,
    [LocalizedDescription("SettingsEnum_Culture_AllCutures")]
    AllCultures = 7
}
#endregion Cultures
