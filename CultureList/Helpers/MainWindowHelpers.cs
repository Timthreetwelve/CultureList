...
{
    #region Startup
    internal static void CultureListStartUp()
    {
        EventHandlers();
        ApplyUISettings();
    }
    ...
    internal static void SetBaseTheme(ThemeType mode)
    {
        ...
        switch (mode)
        {
            case ThemeType.Light:
                ...
                theme.TextBoxes.OutlineBorder = (Color)ColorConverter.ConvertFromString("#FFC0C0C0");
                break;
            case ThemeType.Dark:
                theme.SetBaseTheme(BaseTheme.Dark);
                theme.TextBoxes.OutlineBorder = (Color)ColorConverter.ConvertFromString("#FF707070");
                break;
            case ThemeType.Darker:
                ...
                theme.TextBoxes.OutlineBorder = (Color)ColorConverter.ConvertFromString("#FF404040");
                break;
            default:
                theme.SetBaseTheme(BaseTheme.Light);
                break;
