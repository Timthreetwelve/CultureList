...
ca.NotSelfContained=Aquesta versió requereix una instal·lació existent de .NET 8 Desktop Runtime i és compatible tant amb sistemes x64 com x86.%n%nEs recomana tancar totes les altres aplicacions abans de continuar.%n%nFeu clic a 'Següent' per continuar, o 'Cancel·la' per sortir de la instal·lació.
...
de.NotSelfContained=Dadurch wird die Standardversion von %1 Version %2 installiert.%n%nDiese Version erfordert eine vorhandenede. Installation von .NET 8 Desktop Runtime und ist sowohl mit x64- als auch mit x86-Systemen kompatibel.%n%nEs wird empfohlen, dass Sie alle anderen Anwendungen schließen, bevor Sie fortfahren.%n%nKlicken Sie auf "Weiter", um fortzufahren, oder auf "Abbrechen", um das Setup zu beenden.
